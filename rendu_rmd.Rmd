...
fonc.a = function(x, y, simga = sigma){
...
$$
a(x_i,x_j) = e^{-0.5(x_i-x_j)^2/\sigma^2_a}
$$
...
cherche maintenant à déterminer, pour deux traitsdonnés comment la
valeur de $\sigma$ influence l'intensité de la compétion
interspécifique.

On commence par résoudre l'EDO pour différentes valeurs de $\sigma$ :

```{r}
val_sig = seq (0.1,20,0.1)
selection <- rep(NULL, length( seq (0.5,20,0.5)))
